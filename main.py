...
# Logging channel
LOG_CHANNEL = -1003035971311  # Replace with your actual log channel ID
...
OWNER_ID = 8433080835  # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [8433080835]

AUTH_CHANNEL = -1003035971311
